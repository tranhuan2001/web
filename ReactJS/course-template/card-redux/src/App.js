            ...
            <header>
               <ul id="slide-out" className="side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default"
                  ...
                  <li>
                     <ul className="social">
                        <li>
                           <a href="#href" className="icons-sm fb-ic">
                              <i className="fa fa-facebook"> </i>
                           </a>
                        </li>
                        <li>
                           <a href="#href" className="icons-sm pin-ic">
                              <i className="fa fa-pinterest"> </i>
                           </a>
                        </li>
                        <li>
                           <a href="#href" className="icons-sm gplus-ic">
                              <i className="fa fa-google-plus"> </i>
                           </a>
                        </li>
                        <li>
                           <a href="#href" className="icons-sm tw-ic">
                  ...
                  <li>
                     ...
                     <ul className="collapsible collapsible-accordion">
                        <li>
                           <a href="#href" className="collapsible-header waves-effect arrow-r">
                        ...
                        <li className="active">
                           <a href="#href" className="collapsible-header waves-effect arrow-r active">
                        ...
                        <li>
                           ...
                           <div className="collapsible-body">
                              <ul>
                                 ...
                                 <li>
                                    <a href="home-page-3-full-page-carousel.html" className="waves-effect">Ecommerce homepage V.3
                                       Full Page Carousel</a>
                                 </li>
                                 <li>
                                    <a href="home-page-3-half-page-carousel.html" className="waves-effect">Ecommerce homepage V.3
                                       Half Page Carousel</a>
                                 </li>
                                 <li>
                        ...
                        <li>
                           ...
                           <div className="collapsible-body">
                              <ul>
                                 ...
                                 <li>
                                    <a href="blog-post-left-column.html" className="waves-effect">Page with newsletter on the
                                       left</a>
                                 </li>
                                 <li>
                                 ...
                                 <li>
                                    <a href="blog-post-full-width.html" className="waves-effect">Full width page with logged
                                       user</a>
                                 </li>
                                 <li>
                                    <a href="blog-post-full-width%20not%20logged%20in%20user.html" className="waves-effect">Full
                                       width page with not logged user</a>
                                 </li>
                              </ul>
                           </div>
                        </li>
                        <li>
                           ...
                           <div className="collapsible-body">
                              <ul>
                                 <li>
                                    <a href="category-list-left-column.html" className="waves-effect">Category list with left
                                       column</a>
                                 </li>
                                 <li>
                                    <a href="category-list-right-column.html" className="waves-effect">Category list with right
                                       column</a>
                                 </li>
                                 <li>
                                    <a href="category-grid-left-column.html" className="waves-effect">Category grid with left
                                       column</a>
                                 </li>
                                 <li>
                                    <a href="category-right-column.html" className="waves-effect">Category grid with right
                                       column</a>
                                 </li>
                                 <li>
                                    <a href="category-grid-left-column-carousel.html" className="waves-effect">Category grid with
                                       left column carousel</a>
                                 </li>
                              </ul>
                           </div>
                        </li>
               ...
               <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
                  ...
                  <div className="float-left">
                     <a href="#href" data-activates="slide-out" className="button-collapse">
                  ...
                  <ul className="nav navbar-nav nav-flex-icons ml-auto">
                     <li className="nav-item dropdown">
                        ...
                        <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                           <a href="#href" className="dropdown-item waves-effect waves-light">Đăng Ký</a>
                           <a href="#href" className="dropdown-item waves-effect waves-light">Đăng Nhập</a>
                           <a href="#href" className="dropdown-item waves-effect waves-light">Đăng Xuất</a>
                        </div>
                     </li>
                  </ul>
                              ...
                              <div className="card-body">
                                 ...
                                 <div className="card-footer">
                                    ...
                                    <span className="right">
                                       <a href="#href" className="btn-floating blue-gradient" data-toggle="tooltip" data-placement="top"
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <button type="button" className="btn btn-sm btn-primary waves-effect waves-light"
                                       data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove item">
                                       X
                                    </button>
                                 </td>
                              </tr>
               ...
               <div className="container-fluid">
                  <div className="row">
                     <div className="col-lg-2 ml-auto">
                        ...
                        <div className="social-section text-md-left">
                           <ul className="text-center">
                              <li>
                                 <a href="#href" className="btn-floating  btn-fb waves-effect waves-light">
                                    <i className="fa fa-facebook"></i>
                                 </a>
                              </li>
                              <li>
                                 <a href="#href" className="btn-floating  btn-ins waves-effect waves-light">
                                    <i className="fa fa-instagram"></i>
                                 </a>
                              </li>
                              <li>
                                 <a href="#href" className="btn-floating  btn-tw waves-effect waves-light">
                                    <i className="fa fa-twitter"></i>
                                 </a>
                              </li>
                              <li>
                                 <a href="#href" className="btn-floating  btn-yt waves-effect waves-light">
                                    <i className="fa fa-youtube"></i>
                                 </a>
                              </li>
                              <li>
                                 <a href="#href" className="btn-floating  btn-li waves-effect waves-light">
                                    <i className="fa fa-linkedin"></i>
                                 </a>
                              </li>
                              <li>
                                 <a href="#href" className="btn-floating  btn-dribbble waves-effect waves-light">
                                    <i className="fa fa-dribbble left"></i>
                                 </a>
                              </li>
                              <li>
                                 <a href="#href" className="btn-floating  btn-pin waves-effect waves-light">
                                    <i className="fa fa-pinterest"></i>
                                 </a>
                              </li>
                              <li>
                                 <a href="#href" className="btn-floating  btn-gplus waves-effect waves-light">
                                    <i className="fa fa-google-plus"></i>
                                 </a>
                              </li>
                           </ul>
                     ...
                     <div className="col-lg-2">
                        ...
                        <ul>
                           <li>
                              <a href="#href">Store Delivery</a>
                           </li>
                           <li>
                              <a href="#href">Online Delivery</a>
                           </li>
                           <li>
                              <a href="#href">Delivery Terms &amp; Conditions</a>
                           </li>
                           <li>
                     ...
                     <div className="col-lg-2">
                        ...
                        <ul>
                           ...
                           <li>
                              <a href="#href">Return Policy</a>
                           </li>
                           <li>
                              <a href="#href">Product Registration</a>
                           </li>
                        </ul>
